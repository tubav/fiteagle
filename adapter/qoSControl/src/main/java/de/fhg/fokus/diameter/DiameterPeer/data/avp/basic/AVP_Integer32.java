/*
 * $Id: AVP_Integer32.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Integer32 extends AVP{
	...
	public AVP_Integer32(AVP_Type type,byte[] data) throws AVPDecodeException
	{
		super(type,data);
		if (data==null||data.length!=4) 
			throw new AVPDecodeException("AVP_Integer32 raw data can only have a length of 4!");
	}

	public AVP_Integer32(int code, boolean mandatory, long vendorId,int data)
	{
		super(code,mandatory,vendorId);
		this.set(data);
	}
	
	public AVP_Integer32(AVP_Type type, int data) {
		super(type);
		this.set(data);
	}
	...
	{
		avpData = new byte[4];
		avpData[0] = (byte)((data>>24) &0xFF);
		avpData[1] = (byte)((data>>16) &0xFF);
		avpData[2] = (byte)((data>> 8) &0xFF);
		avpData[3] = (byte)((data    ) &0xFF);
	}
	...
	public synchronized String toString()
	{
		...
		x.append(" Integer32_Data=");x.append(this.get());
		return x.toString();
	}		
}
