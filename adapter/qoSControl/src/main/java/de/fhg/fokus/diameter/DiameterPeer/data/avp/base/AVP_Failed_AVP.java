/*
 * $Id: AVP_Failed_AVP.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Failed_AVP extends AVP_Grouped {

	public AVP_Failed_AVP(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Failed_AVP,data);
	}
	
	public AVP_Failed_AVP(AVP[] data)
	{
		super(AVP_Type.Failed_AVP,data);
	}

	public AVP_Failed_AVP(Vector<AVP> data)
	{
		super(AVP_Type.Failed_AVP,data);
	}
