/*
 * $Id: AVP_Multi_Round_Time_Out.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Multi_Round_Time_Out extends AVP_Unsigned32 {

	public AVP_Multi_Round_Time_Out(byte[] data) throws AVPDecodeException {
		super(AVP_Type.Multi_Round_Time_Out, data);		
	}
	
	public AVP_Multi_Round_Time_Out(long data) throws AVPDataTypeException {
		super(AVP_Type.Multi_Round_Time_Out, data);		
	}
