/*
 * $Id: AVP_Product_Name.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Product_Name extends AVP_UTF8String{
	
	public AVP_Product_Name(byte[] data) throws AVPDecodeException  
	{
		super(AVP_Type.Product_Name, data);
	}	
	
	public AVP_Product_Name(String data) throws UnsupportedEncodingException 
	{
		super(AVP_Type.Product_Name, data);
	}	
