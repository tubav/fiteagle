/*
 * $Id: AVP_Flow_Number.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Flow_Number extends AVP_Unsigned32 {

	public AVP_Flow_Number(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Flow_Number,data);
	}
	
	public AVP_Flow_Number(long data) throws AVPDataTypeException {
		super(AVP_Type.Flow_Number, data);		
	}
