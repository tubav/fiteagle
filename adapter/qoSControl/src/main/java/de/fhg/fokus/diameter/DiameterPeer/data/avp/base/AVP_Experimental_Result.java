/*
 * $Id: AVP_Experimental_Result.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Experimental_Result extends AVP_Grouped {

	public AVP_Experimental_Result(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Experimental_Result,data);
	}
	
	public AVP_Experimental_Result(AVP[] data)
	{
		super(AVP_Type.Experimental_Result,data);
	}

	public AVP_Experimental_Result(Vector<AVP> data)
	{
		super(AVP_Type.Experimental_Result,data);
	}
