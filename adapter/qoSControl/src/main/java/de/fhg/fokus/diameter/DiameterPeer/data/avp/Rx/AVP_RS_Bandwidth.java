/*
 * $Id: AVP_RS_Bandwidth.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_RS_Bandwidth extends AVP_Unsigned32 {

	public AVP_RS_Bandwidth(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.RS_Bandwidth,data);
	}
	
	public AVP_RS_Bandwidth(long data) throws AVPDataTypeException {
		super(AVP_Type.RS_Bandwidth, data);		
	}
