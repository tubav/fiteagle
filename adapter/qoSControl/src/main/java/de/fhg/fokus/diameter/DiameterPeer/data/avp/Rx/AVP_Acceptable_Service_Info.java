/*
 * $Id: AVP_Acceptable_Service_Info.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Acceptable_Service_Info extends AVP_Grouped {

	public AVP_Acceptable_Service_Info(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Acceptable_Service_Info,data);
	}
	
	public AVP_Acceptable_Service_Info(AVP[] data)
	{
		super(AVP_Type.Acceptable_Service_Info,data);
	}

	public AVP_Acceptable_Service_Info(Vector<AVP> data)
	{
		super(AVP_Type.Acceptable_Service_Info,data);
	}
