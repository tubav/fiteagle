/*
 * $Id: AVP_Origin_State_Id.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Origin_State_Id extends AVP_Unsigned32 {

	public AVP_Origin_State_Id(byte[] data) throws AVPDecodeException{
		super(AVP_Type.Origin_State_Id, data);		
	}
	public AVP_Origin_State_Id(long data) throws AVPDataTypeException {
		super(AVP_Type.Origin_State_Id, data);		
	}
