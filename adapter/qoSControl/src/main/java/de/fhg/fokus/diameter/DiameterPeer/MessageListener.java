/*
 * $Id: MessageListener.java 1948 2010-07-15 17:01:34Z dvi $
 *
...
public interface MessageListener {
	...
	/**
	 * Handles the received Diameter request.
	 * 
	 * @param FQDN 	FQDN of the origin host. 
	 * @param msg 	Received Diameter message.
	 */
	public abstract void recvRequest(String FQDN,Request req);
	
	/**
	 * Handles the received Diameter answer.
	 * 
	 * @param FQDN 	FQDN of the origin host. 
	 * @param msg 	Received Diameter message.
	 */
	public abstract void recvAnswer(String FQDN,Answer ans);
