/*
 * $Id: AVP_Auth_Grace_Period.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Auth_Grace_Period extends AVP_Unsigned32 {

	public AVP_Auth_Grace_Period(byte[] data) throws AVPDecodeException {
		super(AVP_Type.Auth_Grace_Period,data);		
	}
	
	public AVP_Auth_Grace_Period(long data) throws AVPDataTypeException {
		super(AVP_Type.Auth_Grace_Period, data);		
	}
