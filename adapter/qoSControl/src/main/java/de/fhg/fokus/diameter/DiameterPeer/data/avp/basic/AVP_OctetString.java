/*
 * $Id: AVP_OctetString.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_OctetString extends AVP{
	...
	public AVP_OctetString(int code, boolean mandatory, long vendorId,byte[] data)
	{
		super(code,mandatory,vendorId);
		this.set(data);
	}
	
	public AVP_OctetString(AVP_Type type, byte[] data) {
		super(type);
		this.set(data);
	}
