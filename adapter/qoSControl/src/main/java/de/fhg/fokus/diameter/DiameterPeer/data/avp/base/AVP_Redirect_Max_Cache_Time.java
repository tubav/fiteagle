/*
 * $Id: AVP_Redirect_Max_Cache_Time.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Redirect_Max_Cache_Time extends AVP_Unsigned32 {

	public AVP_Redirect_Max_Cache_Time(byte[] data) throws AVPDecodeException {
		super(AVP_Type.Redirect_Max_Cache_Time, data);		
	}
	
	public AVP_Redirect_Max_Cache_Time(long data) throws AVPDataTypeException {
		super(AVP_Type.Redirect_Max_Cache_Time, data);		
	}
