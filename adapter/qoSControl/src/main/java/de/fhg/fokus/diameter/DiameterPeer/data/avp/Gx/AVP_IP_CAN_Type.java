/*
 * $Id: AVP_IP_CAN_Type.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_IP_CAN_Type extends AVP_Enumerated {
		
	public AVP_IP_CAN_Type(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.IP_CAN_Type,data);		
	}
	
	public AVP_IP_CAN_Type(int data) {
		super(AVP_Type.IP_CAN_Type, data);
	}
	...
	public String toString()
	{
		...
		int value = this.get();
		for(AVP_IP_CAN_Type_Enum e: AVP_IP_CAN_Type_Enum.values())
