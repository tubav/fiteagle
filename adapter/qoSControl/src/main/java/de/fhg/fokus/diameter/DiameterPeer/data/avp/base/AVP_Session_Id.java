/*
 * $Id: AVP_Session_Id.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Session_Id extends AVP_UTF8String{

	public AVP_Session_Id(byte[] data) throws AVPDecodeException 
	{
		super(AVP_Type.Session_Id,data);
	}
	
	public AVP_Session_Id(String data) throws UnsupportedEncodingException
	{
		super(AVP_Type.Session_Id,data);
	}
}
