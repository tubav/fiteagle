/*
 * $Id: Peer.java 1967 2010-07-19 10:49:22Z dvi $
 *
...
public class Peer {
	...
	private static final Logger LOGGER = Logger.getLogger(Peer.class.toString());
	...
	public PeerState state=PeerState.Closed;
	...
	/** The CER received from the R-comm */
	public Message R_CER;
