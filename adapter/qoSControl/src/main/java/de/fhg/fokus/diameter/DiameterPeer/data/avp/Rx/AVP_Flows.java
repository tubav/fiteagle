/*
 * $Id: AVP_Flows.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Flows extends AVP_Grouped {

	public AVP_Flows(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Flows,data);
	}
	
	public AVP_Flows(AVP[] data)
	{
		super(AVP_Type.Flows,data);
	}

	public AVP_Flows(Vector<AVP> data)
	{
		super(AVP_Type.Flows,data);
	}
