/*
 * $Id: AVP_DiameterIdentity.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_DiameterIdentity extends AVP{

	
	public AVP_DiameterIdentity(AVP_Type type,byte[] data) throws AVPDecodeException
	{
		super(type,data);		
	}

	public AVP_DiameterIdentity(int code, boolean mandatory, long vendorId,String data)
	{
		super(code,mandatory,vendorId);
		this.set(data);
	}
	
	public AVP_DiameterIdentity(AVP_Type type, String data) {
		super(type);
		this.set(data);
	}
	...
	public synchronized String toString()
	{
		...
		x.append(" DiameterIdentity_Data=");x.append(this.get());
		return x.toString();
	}
}
