/*
 * $Id: AVP_Acct_Application_Id.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Acct_Application_Id extends AVP_Unsigned32 {

	public AVP_Acct_Application_Id(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Acct_Application_Id,data);
	}
	
	public AVP_Acct_Application_Id(long data) throws AVPDataTypeException {
		super(AVP_Type.Acct_Application_Id, data);		
	}
