/*
 * $Id: AVP_Error_Message.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Error_Message extends AVP_UTF8String{

	public AVP_Error_Message(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Error_Message,data);
	}

	public AVP_Error_Message(String data) throws UnsupportedEncodingException
	{
		super(AVP_Type.Error_Message,data);
	}
}
