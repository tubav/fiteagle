/*
 * $Id: SessionEvent.java 1971 2010-07-20 08:41:28Z dvi $
 *
...
public class SessionEvent {
	...
	public SessionEventType type = null;
	...
	public SessionEvent(AuthSessionEventType type) {
		this.type = type;
	}


	public SessionEvent(AuthSessionEventType type, Message msg) {
		this.type = type;
		this.msg = msg;
	}
