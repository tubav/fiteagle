/*
 * $Id: AVP_Session_Timeout.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Session_Timeout extends AVP_Unsigned32 {

	public AVP_Session_Timeout(byte[] data) throws AVPDataTypeException, AVPDecodeException {
		super(AVP_Type.Session_Timeout, data);		
	}
	
	public AVP_Session_Timeout(long data) throws AVPDataTypeException {
		super(AVP_Type.Session_Timeout, data);		
	}
