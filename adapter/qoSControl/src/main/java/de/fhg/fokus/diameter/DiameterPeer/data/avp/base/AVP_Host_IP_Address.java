/*
 * $Id: AVP_Host_IP_Address.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Host_IP_Address extends AVP_Address {
	
	public AVP_Host_IP_Address(byte[] data) throws AVPDecodeException 
	{
		super(AVP_Type.Host_IP_Address, data);
	}	
	
	public AVP_Host_IP_Address(InetAddress data) 
	{
		super(AVP_Type.Host_IP_Address, data);
	}	
