/*
 * $Id: AVP_Flow_Status.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Flow_Status extends AVP_Enumerated {
		
	public AVP_Flow_Status(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Flow_Status,data);		
	}
	
	public AVP_Flow_Status(int data) {
		super(AVP_Type.Flow_Status, data);
	}
	...
	public String toString()
	{
		...
		int value = this.get();
		for(AVP_Flow_Status_Enum e: AVP_Flow_Status_Enum.values())
