/*
 * $Id: AVP_Media_Type.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Media_Type extends AVP_Enumerated {
		
	public AVP_Media_Type(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Media_Type,data);		
	}
	
	public AVP_Media_Type(int data) {
		super(AVP_Type.Media_Type, data);
	}
	...
	public String toString()
	{
		...
		int value = this.get();
		for(AVP_Media_Type_Enum e: AVP_Media_Type_Enum.values())
