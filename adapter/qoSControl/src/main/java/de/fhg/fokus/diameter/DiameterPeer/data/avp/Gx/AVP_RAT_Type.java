/*
 * $Id: AVP_RAT_Type.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_RAT_Type extends AVP_Enumerated {
		
	public AVP_RAT_Type(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.RAT_Type,data);		
	}
	
	public AVP_RAT_Type(int data) {
		super(AVP_Type.RAT_Type, data);
	}
	...
	public String toString()
	{
		...
		int value = this.get();
		for(AVP_RAT_Type_Enum e: AVP_RAT_Type_Enum.values())
