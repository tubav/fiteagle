/*
 * $Id: AVP_Result_Code.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Result_Code extends AVP_Unsigned32 {

	public AVP_Result_Code(byte[] data) throws AVPDecodeException {
		super(AVP_Type.Result_Code, data);		
	}
	
	public AVP_Result_Code(long data) throws AVPDataTypeException {
		super(AVP_Type.Result_Code, data);		
	}
	...
	public String toString()
	{
		...
		long value = this.get();
		for(AVP_Result_Code_Enum e: AVP_Result_Code_Enum.values())
