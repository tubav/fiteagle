/*
 * $Id: AVP_Acct_Interim_Interval.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Acct_Interim_Interval extends AVP_Unsigned32 {

	public AVP_Acct_Interim_Interval(byte[] data) throws AVPDecodeException {
		super(AVP_Type.Acct_Interim_Interval,data);		
	}
	
	public AVP_Acct_Interim_Interval(long data) throws AVPDataTypeException {
		super(AVP_Type.Acct_Interim_Interval, data);		
	}
