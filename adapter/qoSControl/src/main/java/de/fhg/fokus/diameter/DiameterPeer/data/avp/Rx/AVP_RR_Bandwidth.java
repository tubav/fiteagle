/*
 * $Id: AVP_RR_Bandwidth.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_RR_Bandwidth extends AVP_Unsigned32 {

	public AVP_RR_Bandwidth(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.RR_Bandwidth,data);
	}
	
	public AVP_RR_Bandwidth(long data) throws AVPDataTypeException {
		super(AVP_Type.RR_Bandwidth, data);		
	}
