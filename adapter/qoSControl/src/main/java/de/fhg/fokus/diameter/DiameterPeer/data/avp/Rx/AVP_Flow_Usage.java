/*
 * $Id: AVP_Flow_Usage.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Flow_Usage extends AVP_Enumerated {
		
	public AVP_Flow_Usage(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Flow_Usage,data);		
	}
	
	public AVP_Flow_Usage(int data) {
		super(AVP_Type.Flow_Usage, data);
	}
	...
	public String toString()
	{
		...
		int value = this.get();
		for(AVP_Flow_Usage_Enum e: AVP_Flow_Usage_Enum.values())
