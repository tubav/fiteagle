/*
 * $Id: IPFilterRule.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class IPFilterRule {
	public IPFilterAction action=IPFilterAction.PERMIT;
	...
	public IPFilterRule(String ipFilterRule) throws AVPDecodeException
	{
		this.set(ipFilterRule);
	}

	public void set(String rule) throws AVPDecodeException 
	{
		this.action = IPFilterAction.PERMIT;
		...
		if (st.hasMoreTokens()){
			token = st.nextToken();
			this.action = IPFilterAction.getType(token);
			if (this.action==null) 
