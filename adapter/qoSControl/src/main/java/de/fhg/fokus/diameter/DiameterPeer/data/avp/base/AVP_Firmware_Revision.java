/*
 * $Id: AVP_Firmware_Revision.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Firmware_Revision extends AVP_Unsigned32
{
	
	public AVP_Firmware_Revision(byte[] data) throws AVPDecodeException 
	{
		super(AVP_Type.Firmware_Revision,data);
	}	
	
	public AVP_Firmware_Revision(long data)	throws AVPDataTypeException 
	{
		super(AVP_Type.Firmware_Revision, data);
	}	
