/*
 * $Id: AVP_Proxy_Info.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Proxy_Info extends AVP_Grouped {

	public AVP_Proxy_Info(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Proxy_Info,data);
	}
	
	public AVP_Proxy_Info(AVP[] data)
	{
		super(AVP_Type.Proxy_Info,data);
	}

	public AVP_Proxy_Info(Vector<AVP> data)
	{
		super(AVP_Type.Proxy_Info,data);
	}
