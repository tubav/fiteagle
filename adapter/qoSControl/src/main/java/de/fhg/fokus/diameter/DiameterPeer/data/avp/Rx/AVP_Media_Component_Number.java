/*
 * $Id: AVP_Media_Component_Number.java 1979 2010-07-20 13:08:28Z dvi $
 *
...
public class AVP_Media_Component_Number extends AVP_Unsigned32 {

	public AVP_Media_Component_Number(byte[] data) throws AVPDecodeException
	{
		super(AVP_Type.Media_Component_Number,data);
	}
	
	public AVP_Media_Component_Number(long data) throws AVPDataTypeException {
		super(AVP_Type.Media_Component_Number, data);		
	}
