/*
 * $Id: AVP_Vendor_Id.java 1950 2010-07-16 13:07:50Z dvi $
 *
...
public class AVP_Vendor_Id extends AVP_Unsigned32{

	public AVP_Vendor_Id(byte[] data)	throws AVPDecodeException 
	{
		super(AVP_Type.Vendor_Id, data);
	}	
	
	public AVP_Vendor_Id(long data)	throws AVPDataTypeException 
	{
		super(AVP_Type.Vendor_Id, data);
	}	
	...
	public String toString()
	{
		...
		long value = this.get();
		for(AVP_Vendor_Id_Enum e: AVP_Vendor_Id_Enum.values())
