/*
 * $Id: AVP_Proxy_State.java 1937 2010-07-15 12:30:50Z dvi $
 *
...
public class AVP_Proxy_State extends AVP_OctetString{

	public AVP_Proxy_State(byte[] data)
	{
		super(AVP_Type.Proxy_State,data);
	}
}
