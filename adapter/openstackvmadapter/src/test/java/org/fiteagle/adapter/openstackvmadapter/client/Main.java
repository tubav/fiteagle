...
import org.fiteagle.adapter.openstackvmadapter.OpenstackVMAdapter;
...
import org.fiteagle.adapter.openstackvmadapter.client.model.ServerForCreate;
...
//		System.out.println(network);
	...
	private static void createServer(OpenstackClient client) {
		org.fiteagle.adapter.openstackvmadapter.client.model.Server server = client.createServer(imageId, flavorId, serverName, keyPairName);
