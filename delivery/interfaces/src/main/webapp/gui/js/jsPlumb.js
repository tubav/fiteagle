...
//				connectorStyle:{ strokeStyle:"#316b31", lineWidth:6 },
		...
		var s1 = instance.addEndpoint('resource1', { anchor:[1 , 0.4 , 0, 1] }, startpoint1);
		s1.addOverlay(["Label", {id:"label", label:"C1", location:[-1.1, 0.5] }]);
		
		var s2 = instance.addEndpoint('resource1', { anchor:[1 , 0.6 , 0, 1] }, startpoint2);
		s2.addOverlay(["Label", {id:"label", label:"C2", location:[-1.1, 0.5] }]);
		
		var e1 = instance.addEndpoint('resource2', { anchor:[0 , 0.4 , 0, 1] }, endpoint1);
		e1.addOverlay(["Label", {id:"label", label:"C1", location:[1.9, 0.5] }]);
		
		var e2 = instance.addEndpoint('resource2', { anchor:[0 , 0.6, 0, 1] }, endpoint2);
		e2.addOverlay(["Label", {id:"label", label:"C2", location:[1.9, 0.5] }]);
