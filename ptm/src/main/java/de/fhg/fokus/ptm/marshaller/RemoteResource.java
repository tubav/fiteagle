...
import de.fhg.fokus.ptm.server.BasicResource;

public class RemoteResource extends BasicResource {

	public RemoteResource(ResourceAdapter adapter, Identifier identifier) {
		super(adapter, identifier);
	}

	public RemoteResource(BasicAbstractResourceAdapter adapter, Identifier parentId,
