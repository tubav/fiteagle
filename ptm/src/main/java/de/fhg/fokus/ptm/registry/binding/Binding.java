package de.fhg.fokus.ptm.registry.binding;
...
{
	URL resolve(Identifier uuid) throws RegistryException;
	Map<Identifier, URL> resolve_all_raw(Identifier uuid) throws RegistryException;
	void register(Identifier uuid, URL url) throws RegistryException;
}
