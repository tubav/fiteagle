...
public class NoSuchResourceException extends PTMException {
	...
	public NoSuchResourceException(Identifier identifier) {
		this(identifier == null ? null :identifier.toString());
	}
