...
public class AllocateTest {
	...
	public void setUp() throws Exception {
		...
		allocateRequestProcessor.setGroupDBManager(groupDBManager);
	}
...
//		
		...
		EasyMock.expectLastCall().anyTimes();
		groupDBManager.updateGroup(EasyMock.anyObject(Group.class));
		EasyMock.expectLastCall().anyTimes();
	...
	private void buildNodeMock() {
		...
		EasyMock.expect(nodeContents.getClientId()).andReturn("componentID");
		EasyMock.expectLastCall().anyTimes();
		EasyMock.replay(node);
