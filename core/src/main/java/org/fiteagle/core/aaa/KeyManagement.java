...
public class KeyManagement {
    ...
    public String encodePublicKey(PublicKey pubKey) throws IOException {
      ...
      if(pubKey.getAlgorithm().equals("RSA")){
          ...
          publicKeyEncoded = new String(
                  Base64.encodeBytes(byteOs.toByteArray()));
          ...
          throw new IllegalArgumentException(
                  "Unknown public key encoding: " + pubKey.getAlgorithm());
      }    }
    ...
    public String getEncryptedPrivateKey(User u, String password) throws NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, IOException{
   
      KeyPair keyPair = generateKeyPair();
      PublicKey pubKey = keyPair.getPublic();
      u.addPublicKey(Base64.encodeBytes(pubKey.getEncoded()));
