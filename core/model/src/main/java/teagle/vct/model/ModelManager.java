...
public abstract class ModelManager {
	...
	public static ModelManager getInstance() {
		if (ModelManager.instance == null)
			try {
				ModelManager.instance = (ModelManager) Class.forName(
						"teagle.vct.tssg.impl.TSSGModelFactory").newInstance();
	...
	public abstract ResourceInstance createResourceInstance(
	...
	public abstract Collection<ResourceInstance> findResourceInstancesByUserName(
			String userName);
	...
	public abstract <T extends Entity> void delete(T obj)
	...
	public abstract List<Organisation> findOrganisationsByUserName(
			String userName);
	...
	// public abstract List<? extends Person>
	// findPersonsByOrganisationName(String organisationName);

	// public abstract List<ResourceSpec> findResourceSpecsByOrganisation(String
	// organisationName);
