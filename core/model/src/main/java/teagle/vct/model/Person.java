...
public interface Person {
	...
	/**
	 * getting the list of organisations. This returns a copy of the list. Any
	...
	/**
	 * getting the list of person's roles. This returns a copy of the list. Any
	 * changes are not reflected on the contained list, use add and remove for
	 * this purpose.
	 * 
	...
	/**
	 * getting the list of email addresses. This returns a copy of the list. Any
	 * changes are not reflected on the contained list, use add and remove for
	 * this purpose.
	 * 
