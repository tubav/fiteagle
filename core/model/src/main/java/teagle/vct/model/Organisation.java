...
public interface Organisation {
	...
	/**
	 * getting the list of organisation roles. This returns a copy of the list.
	 * Any changes are not reflected on the contained list, use add and remove
	 * for this purpose.
	 * 
	...
	/**
	 * getting the list of resource specifications. This returns a copy of the
	 * list. Any changes are not reflected on the contained list, use add and
	...
	/**
	 * getting the list of persons. This returns a copy of the list. Any changes
	 * are not reflected on the contained list, use add and remove for this
	 * purpose.
	 * 
