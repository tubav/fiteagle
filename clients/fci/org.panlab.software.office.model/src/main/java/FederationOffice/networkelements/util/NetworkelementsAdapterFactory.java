...
public class NetworkelementsAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link FederationOffice.networkelements.Device <em>Device</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link FederationOffice.networkelements.NetworkElement <em>Network Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
